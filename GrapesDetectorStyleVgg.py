...
def main(mode):
    ...
    if mode == 'test':
        ...
        for i,elem in enumerate(n_features):
            ...
            if len(os.listdir('models//vgg//')) < len(n_features): #some of the models are not present in the models folder 
            ...
            loaded_model_vgg.load_state_dict(load('models//vgg//grapes_detector_vgg'+str(i)+'.pt'))
       ...
       #deleting existing vggs model
        for i in range(len(n_features)):
            if os.path.isfile('models//vgg//grapes_detector_vgg'+str(i)+'.pt'):
                os.remove('models//vgg//grapes_detector_vgg'+str(i)+'.pt')
        ...
        for i,elem in enumerate(n_features):
            ...
            with open('models//vgg//grapes_detector_vgg'+str(i)+'.pt', 'wb') as fsave: 
